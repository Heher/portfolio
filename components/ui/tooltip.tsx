    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            `
              z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-md bg-better-white px-3 py-1.5 text-xs text-better-black
        ...
        >
          ...
          <TooltipPrimitive.Arrow className="
            z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-[2px] bg-better-white fill-better-white
