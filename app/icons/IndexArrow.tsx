...
const IndexArrow = forwardRef<SVGSVGElement, Props>(function Arrow(props: Props, ref: Ref) {
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="9 22 82 55" className={props.className}>
