        ...
        <div className="relative w-full max-w-lg">
          <motion.button
            ...
            animate={{
              width: expand ? 40 : '100%',
              top: expand
                ? getClosePosition(ref.current?.getBoundingClientRect().height, containerRef.current?.offsetHeight)
                : 0,
              right: expand ? -20 : 0,
          ...
          <FlagContainer
            expand={expand}
            expandHeight={containerRef.current?.offsetHeight}
            contentWidth={ref.current?.getBoundingClientRect()}
          />
        </div>
      </div>
    </main>
