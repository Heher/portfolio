...
import { basicVariants } from '~/components/animationVariants';
    ...
    >
      <div className="body-container mx-auto h-[100dvh] max-w-[var(--max-width)]">
        <motion.div
          ...
          initial="hidden"
          animate={routeSelected || selectedCity || showDetails ? 'shown' : 'hidden'}
        >
          <div
        ...
        <MainText showDetails={showDetails} olympiads={olympiads} visits={visitData.olympiads} />
