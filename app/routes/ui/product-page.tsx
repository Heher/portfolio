      ...
      <div className="mx-auto flex w-full max-w-xl flex-col pb-8">
        ...
        <div className="mt-10">
          ...
          <p className="my-5 text-lg text-[#282B27]">
            For all my fellow Millenials out there.
          </p>
        </div>
      </div>
      <div className="h-full bg-linear-to-b from-product-page to-product-page-dark pt-30 pb-60">
        <div className="mx-auto w-full max-w-4xl bg-better-white p-3">
          <div className="w-full p-7.5">
            <div className="relative flex h-full gap-10 rounded-lg">
              ...
              <div className="flex max-w-87.5 flex-col justify-between py-5">
                ...
                <button
                  type="button"
                  className="
                    mt-15 w-full rounded-lg bg-product-page px-5 py-3 text-lg font-semibold text-better-white transition-colors
                    hover:bg-product-page-soft
                  "
                >
                  Add to cart
                </button>
            ...
            <div className="flex items-center gap-14 px-10">
              <span className="block pl-18 font-serif text-3xl">&ldquo;My life was truly complete once I had the piece of our radical rock in my home.&rdquo;</span>
