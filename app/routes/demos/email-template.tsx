...
import { ZEmailFormData } from '@/types/demos/email';
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <UIPageBody
        ...
        className="
          flex h-full min-h-dvh flex-1 flex-col bg-linear-to-b from-blue-slate-top to-blue-slate-bottom px-2.5 py-5
          sm:p-0
        "
      >
        <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col justify-center">
          <div className="mx-auto flex w-full max-w-4xl items-center justify-center">
            <div className="w-100 rounded-2xl bg-better-white p-5 shadow-lg">
              <Form className="flex flex-col" method="post" action="/demos/email-template" navigate={false} fetcherKey="email-form">
