...
export const cities = [
  ...
  { coord: coordinates['lakePlacid'], scale: 2.2, name: 'lake-placid', type: 'winter', years: ['1932'] },
  ...
  { coord: coordinates['mexico'], scale: 2.2, name: 'mexico-city', type: 'summer', years: ['1968'] },
  { coord: coordinates['grenoble'], scale: 2.2, name: 'grenoble', type: 'winter', years: ['1968'] },
  { coord: coordinates['sapporo'], scale: 2.2, name: 'sapporo', type: 'winter', years: ['1972'] },
  { coord: coordinates['munich'], scale: 2.2, name: 'munich', type: 'summer', years: ['1972'] },
  { coord: coordinates['montreal'], scale: 2.2, name: 'montreal', type: 'summer', years: ['1976'] },
  { coord: coordinates['moscow'], scale: 2.2, name: 'moscow', type: 'summer', years: ['1980'] },
  { coord: coordinates['sarajevo'], scale: 2.2, name: 'sarajevo', type: 'winter', years: ['1984'] },
  { coord: coordinates['calgary'], scale: 2.2, name: 'calgary', type: 'winter', years: ['1988'] },
  { coord: coordinates['seoul'], scale: 2.2, name: 'seoul', type: 'summer', years: ['1988'] },
  { coord: coordinates['barcelona'], scale: 2.2, name: 'barcelona', type: 'summer', years: ['1992'] },
  ...
  { coord: coordinates['atlanta'], scale: 2.2, name: 'atlanta', type: 'summer', years: ['1996'] },
  { coord: coordinates['nagano'], scale: 2.2, name: 'nagano', type: 'winter', years: ['1998'] },
  { coord: coordinates['sydney'], scale: 2.2, name: 'sydney', type: 'summer', years: ['2000'] },
  { coord: coordinates['saltLake'], scale: 2.2, name: 'salt-lake-city', type: 'winter', years: ['2002'] },
  { coord: coordinates['torino'], scale: 2.2, name: 'torino', type: 'winter', years: ['2006'] },
  { coord: coordinates['beijing'], scale: 2.2, name: 'beijing', type: 'summer', years: ['2008'] },
  { coord: coordinates['vancouver'], scale: 2.2, name: 'vancouver', type: 'winter', years: ['2010'] },
  { coord: coordinates['sochi'], scale: 2.2, name: 'sochi', type: 'winter', years: ['2014'] },
  { coord: coordinates['rio'], scale: 2.2, name: 'rio-de-janeiro', type: 'summer', years: ['2016'] },
  { coord: coordinates['pyeongchang'], scale: 2.2, name: 'pyeongchang', type: 'winter', years: ['2018'] }
];
