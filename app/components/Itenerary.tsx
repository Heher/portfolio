...
export function Itenerary({ setExpand }: IteneraryProps) {
  ...
  return (
    <motion.div className="relative w-full" layoutId="itenerary">
      <motion.div
        className="absolute top-10 z-10 h-16 w-full px-0.5"
      ...
      >
        <div className="h-16 w-full bg-linear-to-b from-[rgba(176,178,178,0.7)] to-transparent"></div>
      </motion.div>
      <motion.button
        layoutId="expand-button"
        className="
          z-20 flex h-10 w-full max-w-lg items-center justify-center border-2 border-[#282B27] bg-[#282B27] text-center text-[#e0e0e0] transition-colors
          hover:bg-[#403a3b]
        "
