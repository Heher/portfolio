...
// float fit(float unscaled, float originalMin, float originalMax, float minAllowed, float maxAllowed) {
//   float unscaledClamped = clamp(unscaled, originalMin, originalMax);
//   return (maxAllowed - minAllowed) * (unscaledClamped - originalMin) / (originalMax - originalMin) + minAllowed;
// }
