...
export default function MainCopy({ variants }: MainCopyProps) {
  return (
    <motion.div
      className="
        bg-linear-to-b from-globe-background to-transparent px-[30px] pt-[5vh]
        md:max-w-md md:bg-none
        lg:max-w-lg
      "
      variants={variants}
      animate="visible"
    ...
    >
      <h1 className="
        text-[2.5rem] leading-[1.2] text-slate-100
        lg:text-5xl
      "
      >
        Olympic trip
      ...
      <p className="
        mt-[30px] text-[1.1rem] text-slate-200
        lg:text-[1.3rem]
      "
      >
