...
export default function TablesUI() {
  return (
    ...
    <UILink url="/demos/tables" title="Tables" image="table-3.png" className="border-0" headerClassName="" bodyClassName="bg-linear-to-b from-mello-top/20 to-mello-bottom/20 rounded-xl" />
  );
}
